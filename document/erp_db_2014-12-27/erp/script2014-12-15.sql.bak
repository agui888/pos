...
-- Created by Tobin on 2014-12-15, 11:08:31 --
----------------------------------------------

spool script2014-12-15.log
...
prompt
prompt Creating table BASE_STORE
prompt =========================
prompt
create table erp.BASE_STORE
(
  id            VARCHAR2(15) not null,
  cityid        NUMBER,
...
comment on table erp.BASE_STORE
  is '商家管理';
comment on column erp.BASE_STORE.id
  is 'ID';
comment on column erp.BASE_STORE.cityid
  is '所属地区ID';
comment on column erp.BASE_STORE.storename
  is '商家名称';
comment on column erp.BASE_STORE.code
  is '营业执照编号';
comment on column erp.BASE_STORE."linkman"
  is '负责人';
comment on column erp.BASE_STORE."tel"
  is '电话号码';
comment on column erp.BASE_STORE."phone"
  is '手机号码';
comment on column erp.BASE_STORE."email"
  is '电子邮件';
comment on column erp.BASE_STORE."address"
  is '地址';
comment on column erp.BASE_STORE."state"
  is '状态0表示启用/1表示停用';
comment on column erp.BASE_STORE.datasource
  is '数据源';
comment on column erp.BASE_STORE.maxconnection
  is '最大连接数';
comment on column erp.BASE_STORE.delflag
  is '删除标记';
comment on column erp.BASE_STORE.rowtime
  is '更新时间';
comment on column erp.BASE_STORE.rowver
  is '版本号';
alter table erp.BASE_STORE
  add constraint BASE_STORE_KEY primary key (ID)
  using index 
  tablespace ERP_SPACE
  pctfree 10
  initrans 2
...
prompt
prompt Creating sequence BASE_STORE_SEQ
prompt ================================
prompt
create sequence erp.BASE_STORE_SEQ
minvalue 10000000
maxvalue 99999999
start with 10000020
increment by 1
