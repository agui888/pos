...
prompt Disabling triggers for T_BASE_SJGL...
alter table T_BASE_SJGL disable all triggers;
...
commit;
prompt Deleting T_BASE_SJGL...
delete from T_BASE_SJGL;
commit;
...
insert into SYSTEM_MENU (id, sid, type, colid, menu, url, ico, power, write, menugroupid, menugroupname, description, delflag, dirico)
values (5005, 5004, 'AUD', 5005, '商家信息', '/guime/base/sjgl_enter.action?menuid=5005', '/global/images/base/pass.png', 1, 0, null, null, null, 0, null);
insert into SYSTEM_MENU (id, sid, type, colid, menu, url, ico, power, write, menugroupid, menugroupname, description, delflag, dirico)
values (5100, 0, 'AUD', 5010, 'POS管理', null, '/global/images/base/dir.png', 1, 0, null, null, null, 0, null);
insert into SYSTEM_MENU (id, sid, type, colid, menu, url, ico, power, write, menugroupid, menugroupname, description, delflag, dirico)
values (5101, 5100, 'AUD', 5011, '商品信息', '/test', '/global/images/base/pass.png', 1, 0, null, null, null, 0, null);
commit;
...
values ('SYS', null, 'ERP', null, '谢少华', '硅米(长沙)信息科技有限公司', '13928851065', 'Linux', 'pop.163.com', 'stmp.163.com', 'xshadmin', '123456', 1269);
commit;
...
prompt Table is empty
prompt Loading T_BASE_SJGL...
insert into T_BASE_SJGL (id, cityid, sjmc, yyzzbh, fzr, dhhm, sjhm, dzyj, dz, zt, datasource, maxconnection, delflag, rowtime, rowver)
...
prompt Enabling triggers for T_BASE_SJGL...
alter table T_BASE_SJGL enable all triggers;
