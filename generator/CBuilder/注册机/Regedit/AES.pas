...
type
  ...
  function EncryptString(Value: string; Key: string; LKeyBit: TKeyBit): string;
  function DecryptString(Value: string; Key: string; LKeyBit: TKeyBit): string;
...
resourcestring
  SInvalidInBufSize = '密文流与加密时的流,大小不对';
  SReadError = '读流错误';
  SWriteError = '写入流错误';
