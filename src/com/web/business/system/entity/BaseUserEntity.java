...
@Alias("BaseUserEntity")
public class BaseUserEntity implements UserEntity {
    ...
    @Excel(Import=true, Export=true, Title="部门ID")
    private String deptid;
    
	private DeptEntity deptEntity;

    @Excel(Import=true, Export=true, Title="职务ID")
    ...
    @Email(message="#username#非法Email地址!")
    ...
    @Excel(Import=true, Export=true, Title="上级领导(经理)")
    private String manageuserid;
    
    private BaseUserEntity manageUserEntity;
	...
	public BaseUserEntity getManageUserEntity() {
		return manageUserEntity;
	}

	public void setManageUserEntity(BaseUserEntity manageUserEntity) {
