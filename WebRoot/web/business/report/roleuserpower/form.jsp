		...
		$(function() {
			grid = $("#cxGrid").datagrid({
                ...
                frozenColumns:[[
							     ...
							     {field:"rrolename",title:"角色名称",width:<e:gridwidth list="${easyGrid}" gridtag="g1" key="rrolename" initial="100"/>,align:"center",rowspan:2},
							     {field:"menu",title:"模块名称",width:<e:gridwidth list="${easyGrid}" gridtag="g1" key="menu" initial="200"/>,rowspan:2},
						      ]],
				columns:[[
				    {title:"模块访问权限", colspan:3},   
				    {title:"模块可写权限", colspan:3},
					...
					{field:"pispower",title:"超级管理员分配",width:<e:gridwidth list="${easyGrid}" gridtag="g1" key="pispower" initial="110"/>,align:"center",
						formatter: function(value,row,index){
                         	if (value == '1')
                           	return "<img src='${path}/global/images/base/drop-yes.gif' style='vertical-align: text-top; border-style: none; margin-right: 0px; margin-top: -1px;'>";
                           else
					...
					{field:"pispower2",title:"实际分配",width:<e:gridwidth list="${easyGrid}" gridtag="g1" key="pispower2" initial="90"/>,align:"center",
						formatter: function(value,row,index){
                         	if (value == '1')
                           	return "<img src='${path}/global/images/base/drop-yes.gif' style='vertical-align: text-top; border-style: none; margin-right: 0px; margin-top: -1px;'>";
                           else
					...
					{field:"piswrite",title:"超级管理员分配",width:<e:gridwidth list="${easyGrid}" gridtag="g1" key="piswrite" initial="110"/>,align:"center",
						formatter: function(value,row,index){
                         	if (value == '1')
                           	return "<img src='${path}/global/images/base/drop-yes.gif' style='vertical-align: text-top; border-style: none; margin-right: 0px; margin-top: -1px;'>";
                           else
					...
					{field:"piswrite2",title:"实际分配",width:<e:gridwidth list="${easyGrid}" gridtag="g1" key="piswrite2" initial="90"/>,align:"center",
						formatter: function(value,row,index){
                         	if (value == '1')
                           	return "<img src='${path}/global/images/base/drop-yes.gif' style='vertical-align: text-top; border-style: none; margin-right: 0px; margin-top: -1px;'>";
                           else
				...
				onLoadSuccess:function(data) {
		            if (data.rows.length>0) {
		                ...
		                mergeCellsByField("cxGrid","rrolename");
		            }
		        },
