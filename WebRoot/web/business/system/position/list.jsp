    ...
    <script>
        ...
        $(function() {
              grid = $("#cxGrid").datagrid({
                    ...
                    columns:[[
                              {field:"positionname", title:"职务名称", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="positionname" initial="240"/>,
                                    formatter:function(value, row) {
                                        return "<a href='${URI}_view.action?menuid=${menuid}&selectid=" + row.id + "&rowno=" + row.rowno + "'>" + value + "</a>";
                                    }
                              },
                              {field:"remark", title:"备注", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="remark" initial="360"/>},
                ...
                <div class="clearfix">
                    ...
                    <form id="searchForm" method="post">
                        <table class="table-xs">
                            <tr>
                                <td width="70" align="right">职务名称</td>
                                <td class="input-group-xs">
                                    <input name="positionEntity.positionname" class="form-control" size="50" type="text" onkeydown="if(event.keyCode==13){ajaxSearch();}"/>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="input-group-xs">
                                    <input name="positionEntity.remark" class="form-control" size="50" type="text" onkeydown="if(event.keyCode==13){ajaxSearch();}"/>
                                </td>
                            </tr>
