    ...
    <script>
        ...
        $(function() {
	            grid = $("#cxGrid").datagrid({
                    ...
                    columns:[[
                              {field:"id", title:"ID", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="id" initial="70"/>,
                                    formatter:function(value, row) {
                                        return "<a href='${URI}_view.action?menuid=${menuid}&selectid=" + row.id + "&rowno=" + row.rowno + "'>" + value + "</a>";
                                    }
                              },
                              {field:"sid", title:"SID", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="sid" initial="70"/>},
                              {field:"type", title:"类型", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="type" initial="60"/>},
                              {field:"colid", title:"序号", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="colid" initial="40"/>},
                              {field:"menu", title:"菜单名称", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="menu" initial="100"/>},
                              {field:"url", title:"URL", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="url" initial="280"/>},
                              {field:"ico", title:"图标", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="ico" initial="300"/>},
                              {field:"power", title:"权限", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="power" initial="40"/>, align:"center"},
                              {field:"write", title:"可写", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="write" initial="40"/>, align:"center"},
                              {field:"menugroupid", title:"工作流ID", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="menugroupid" initial="60"/>, align:"center"},
                              {field:"menugroupname", title:"工作流模块名称", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="menugroupname" initial="100"/>, align:"center"},
                              {field:"delflag", title:"删除标记", sortable:true, width: <e:gridwidth list="${easyGrid}" gridtag="grid1" key="delflag" initial="70"/>, align:"center"},
                        ...
                        <table class="table-xs">
                            <tr>
                                ...
                                <td class="input-group-xs">
                                    <input name="menuEntity.menu" class="form-control" size="50" type="text" onkeydown="if(event.keyCode==13){ajaxSearch();}"/>
                                </td>
