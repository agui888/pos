        ...
        $(function() {
              grid = $("#cxGrid").datagrid({
                    ...
                    frozenColumns:[[
                                    ...
                                    {title:"CREATEUSERID", field:"createuserid", width:100, hidden:true},
                                    ...
                                    formatter:function(value, row) {
                                        <c:if test="${writePower ne true}">
                                            var str = "<div class='hidden-sm hidden-xs action-buttons'>" +
                                                           "<a class='green' href='#' onclick='ajaxModify(\"${menuid}\", \"${URI}\", \"" + row.id + "\", validForm , grid, $(\"#rolename\"), false)'>" +
    ...
    <script>
        function powerRow(rolename, id) {
        	openIframeBootstrap("角色权限分配 - " + rolename + ")", "${path}/system/managepower_enter.action?menuid=${menuid}&roleid=" + id);
        }
    </script>    
                        ...
                        <table class="table-xs">
	                        <tr>
	                            ...
	                            <td class="input-group-xs">
	                                <input name="manageRoleEntity.rolename" class="form-control" size="50" type="text" onkeydown="if(event.keyCode==13){ajaxSearch();}"/>
	                            </td>
	                            <td width="180" align="center" rowspan="2">
	                                ...
	                                <button type="reset" class="btn btn-sm btn-primary" data-rel="tooltip" data-placement="bottom" title="新建" onclick="ajaxAppend('${menuid}', '${URI}', validForm, $('#rolename'));">
	                        ...
	                        <tr>
	                            ...
	                            <td class="input-group-xs">
	                                <input name="manageRoleEntity.remark" class="form-control" size="50" type="text" onkeydown="if(event.keyCode==13){ajaxSearch();}"/>
	                            </td>
	                        </tr>
                        </table>
                    </form>
        ...
        <div class="modal-dialog">
           <div class="modal-content">
               <div class="modal-header">
                   ...
                   <h4 class="modal-title" id="editModalLabel">角色管理</h4>
               </div>
                   ...
                   <form id="saveForm" method="post" action="${URI}_save.action?ajax=true&menuid=${menuid}" class="saveCalss form-horizontal" role="form">
                       ...
                       <tr>
                           ...
                           <td width="53%" class="input-group-xs">
                               <input class="form-control" type="text" id="rolename" name="manageRoleEntity.rolename" style="width: 300px;" maxlength="50" sucmsg="当前角色名称验证通过!" nullmsg="请输入角色名称!" datatype="*1-50" errormsg="角色名称至少1个字符,最多50个字符!" ajaxurl=""  />
                           </td>
                           <td>
                       ...
                       <tr>
                           ...
                           <td class="input-group-xs">
                               <textarea class="form-control" id="remark" name="manageRoleEntity.remark" style="vertical-align: top; width: 300px; height: 130px;"></textarea>
                           </td>
                           <td>
                               &nbsp;
                           </td>
