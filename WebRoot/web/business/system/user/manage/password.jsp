...
<html lang="en">
  <head>
	...
	<script>
	    ...
	    function submitForm() {
	        if (rf.check()) {
	        	$("#manageUserEntityPassword").val($("#repassword").val()); 
	        	$("#saveForm").submit();
	        }
	    }
	</script>
...
<body style="background-color: #fff">
    ...
    <form class="passwordForm" id="saveForm" name="saveForm" action="${path}/system/manageuser_password.action" method="post">
		<input type="hidden" id="menuid" name="menuid" value="${menuid}" />
		<input type="hidden" id="save" name="save" value="password" />
		<input type="hidden" id="manageUserEntityPassword" name="manageUserEntity.password" />

		<input type="hidden" name="manageUserEntity.id" value="${manageUserEntity.id}" />
		<input type="hidden" name="manageUserEntity.userid" value="${manageUserEntity.userid}" />
