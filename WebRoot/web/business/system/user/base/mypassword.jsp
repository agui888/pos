...
<body style="background-color: #fff">
    ...
    <form class="passwordForm" id="saveForm" name="saveForm" action="${path}/system/baseuser_mypassword.action" method="post">
			...
			<table width="400" class="table-xs">
				<tr>
	               ...
	               <td width="80" class="input-group-xs">
	                   <input class="form-control inputxt" type="password" name="oldpassword" 
	                   		  datatype="*3-10" 
	                   		  sucmsg="" 
	                   		  nullmsg="请输入旧密码" 
	                   		  errormsg="密码至少是3~10位!"/>
	               ...
	               <td>
	                   <div class="Validform_checktip">请输入旧的密码.</div>
	               </td>
	           </tr>
	           <tr>
	               <td align="right">
